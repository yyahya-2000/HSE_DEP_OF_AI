...
POSTGRES_SUPERSET_DB = os.environ.get('POSTGRES_SUPERSET_DB')
POSTGRES_HOST = 'db'
POSTGRES_PORT = 5432
CONTENT_SECURITY_POLICY_WARNING = False

# The SQLAlchemy connection string.
SQLALCHEMY_DATABASE_URI = f'postgresql://{POSTGRES_USER}:{POSTGRES_PASSWORD}@{POSTGRES_HOST}:{POSTGRES_PORT}/{POSTGRES_SUPERSET_DB}'
